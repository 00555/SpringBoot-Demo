...
public class LogAspect {
	...
	@Pointcut("execution(public * com.loveincode.controller.*.add*(..))")
	public void addpointcut() {
	}

	@Pointcut("execution(public * com.loveincode.controller.*.delete*(..))")
	public void deletepointcut() {
	}

	@Pointcut("execution(public * com.loveincode.controller.*.update*(..))")
	public void updatepointcut() {
	}

	@Pointcut("execution(public * com.loveincode.controller.*.query*(..))")
