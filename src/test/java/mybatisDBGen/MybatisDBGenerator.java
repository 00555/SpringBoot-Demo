...
import static mybatisDBGen.DBGenConsts.*;

//Mybatis自动生成Java文件
public class MybatisDBGenerator {
	// JDBC configuration
	private static final String JDBC_URL = "jdbc:mysql://localhost:3306/sblearning";
	private static final String JDBC_USERNAME = "root";
	private static final String JDBC_PASSWORD = "kdc";
	...
	private static final String AUTHOR = "loveincode";// @author
	private static final String DATE = new SimpleDateFormat("yyyy/MM/dd").format(new Date());// @date

	public static void main(String[] args) {
		// genCode("t_user");
		genCodeByCustomModelName("t_news", "News");
	}
